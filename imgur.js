    ...
    Imgur.prototype = {
        ...
        createDragZone: function () {
            var p1, p2, input;
                ...
                p1 = this.createEls('p', {}, 'Solte a Imagem aqui');
                p2 = this.createEls('p', {}, 'Ou click aqui para selecionar a imagem');
        ...
        loading: function () {
            ...
            img = this.createEls('img', {className: 'loading-image', src: './assets/css/loading-spin.svg'});
        ...
        matchFiles: function (file, zone) {
            ...
            if (file.type.match(/image/) && file.type !== 'image/svg+xml') {
                ...
                status.innerHTML = 'Arquivo inválido';
            }
        },
